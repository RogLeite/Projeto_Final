...
\myworries{Hermann, na tua opinião: Mais algum conceito que deve entrar? Algum desses pode sair?}
\begin{itemize}
    \item Andamento
    \item Ritmo
...
\myworries{Tenho que escanear uma imagem da \ca}
...
Vamos limitar, então, o escopo do conjunto de dados de toques do pandeiro para apenas um instrumento: Um pandeiro de 11 polegadas, membrana de couro de \myworries{? estou esperando resposta do lutier que botou a pele} e platinelas de latão.
